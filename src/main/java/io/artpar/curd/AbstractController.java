...
public abstract class AbstractController {
  ...
  final Map<String, TableData> tableNames = new HashMap<>();
  final Logger logger = LoggerFactory.getLogger(SchemaController.class);
  Resource.Builder rootResource;

  String context;
  Map<String, AbstractTableController.ForeignKey> foreignKeyMap = new HashMap<>();


  AbstractController(String context, String root, DataSource dataSource, ObjectMapper objectMapper) throws SQLException, NoSuchMethodException {
  ...
  TableResult paginatedResult(String columns, String restOfTheClause,
